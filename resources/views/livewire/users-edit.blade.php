<div>
    <form wire:submit.prevent="save">
        ...
        font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"><i
                    ...
                    @endif
                    <button type="button" wire:click="changePass"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm
                px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Aplicar</button>
                </div>
            </div>
            <div class="mb-6">
                <label for="users_max_online"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Maximo de usuarios conectados
                </label>
                <input type="text" id="users_max_online" wire:model.lazy='users_max_online'
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500
                block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required autocomplete="off">
            </div>
            <div class="mb-6">
                <label for="max_download_numbers"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Maximo de descargas
                </label>
                <input type="text" id="max_download_numbers" wire:model.lazy='max_download_numbers'
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500
                block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required autocomplete="off">
            </div>
